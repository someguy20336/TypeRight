...
namespace Epic.Internals.Shared.ClientScriptGeneration
{
    ...
    /// </summary>
    public class JavascriptObjectGenerator : JavascriptGenerator<ClientScriptObjectAttribute>
    {
        ...
        protected override void GenerateJavascriptForNamespace(List<TypeAttributePair<ClientScriptObjectAttribute>> foundTypes)
        {
            foreach (TypeAttributePair<ClientScriptObjectAttribute> typePair in foundTypes)
            {
