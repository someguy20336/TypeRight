...
namespace Epic.Internals.Shared.ClientScriptGeneration
{
	...
	/// </summary>
	public class TypescriptObjectGenerator : TypescriptGenerator<ClientScriptObjectAttribute>
	{
		/// <summary>
		...
		{
			AddFormatLine(1, "export class {0} {{", TypeUtils.GetTypeName(type));
		}
		...
		protected override void GenerateTypescriptForTypeMembers(TypeAttributePair<ClientScriptObjectAttribute> typeAttr)
		{
