...
|actionConfigurations| Array of ActionConfiguration | This is an array of "Action Configuration" object (below).  You can add multiple configurations, but you should have (at most) one for each request method (Get, Post) and you should also specify the default |
