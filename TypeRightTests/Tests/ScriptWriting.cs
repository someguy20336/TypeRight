		...
		public static void SetupParse(TestContext context)
		{
			...
			wkspBuilder.DefaultProject
				...
				.CreateClassBuilder("DummyAttribute")
					...
					.Commit()
				.CreateClassBuilder("FakeFromBodyAttribute")
					.AddBaseClass("Attribute")
					.Commit()
				.CreateClassBuilder("FakeFromServicesAttribute")
					.AddBaseClass("Attribute")
					.Commit()
				...
				.CreateClassBuilder("TestParamAttributesController")
					.AddMethod("TestingParamFilter", "FakeJsonResultLikeClass")
						.AddAttribute("DummyAttribute").Commit()
						.AddParameter("fromBody", "string", attributes: "[FakeFromBody]")
						.AddParameter("fromServices", "TestClass", attributes: "[FakeFromServices]")
					...
					.AddMethod("NoFromBodyParams", "FakeJsonResultLikeClass")
						.AddAttribute("DummyAttribute").Commit()
						.AddParameter("fromServices", "TestClass", attributes: "[FakeFromServices]")
						.AddParameter("fromServices2", "string", attributes: "[FakeFromServices]")
						.AddParameter("fromServices3", "string", attributes: "[FakeFromServices]")
						.AddLineOfCode("return FakeJson(0);", 0)
						.Commit()
					.Commit()
			;
			...
			wkspBuilder.ClassParseFilter = new ExcludeWithAnyName("DummyAttribute", 
				"SimpleController", "FakeJsonResultLikeClass", "FakeFromServicesAttribute", "FakeFromBodyAttribute",
...
"
		...
		public void Controllers_ExcludingNonFromBodyParameters()
		{
			...
			context.AdditionalParameters = new List<ActionParameter>();	// clear out for simplicity
			context.MvcParameterFilter = new ParameterHasAttributeFilter(new AcceptWithName("FakeFromBodyAttribute"));
			_packageTester.AssertScriptText("TestParamAttributesController",
				context,
			#region ScriptText	
				@"
// File Autogenerated by TypeRight.  DO NOT EDIT
