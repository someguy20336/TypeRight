			...
			wkspBuilder.DefaultProject
				...
				.CreateClassBuilder("TestParamAttributesController")
					.AddMethod("TestingParamFilter", "FakeJsonResultLikeClass")
						.AddAttribute("DummyAttribute").Commit()
						.AddParameter("fromBody", "string", attribute: "FakeFromBody")
						.AddParameter("fromServices", "TestClass", attribute: "FakeFromServices")
					...
					.AddMethod("NoFromBodyParams", "FakeJsonResultLikeClass")
						.AddAttribute("DummyAttribute").Commit()
						.AddParameter("fromServices", "TestClass", attribute: "FakeFromServices")
						.AddParameter("fromServices2", "string", attribute: "FakeFromServices")
						.AddParameter("fromServices3", "string", attribute: "FakeFromServices")
						.AddLineOfCode("return FakeJson(0);", 0)
						.Commit()
					.Commit()
			;
